define("./workbox-c8067db1.js", ["exports"], (function (e) {
  "use strict";
  try {
  ...
  const a = (e, t) => e.filter(e => t in e),
    l = async ({
      ...
      if (!n) throw new r("cache-put-with-no-response", {
        url: i(w.url)
      });
      let d = await u({
        event: s,
      ...
      const p = await self.caches.open(e),
        y = a(c, "cacheDidUpdate");
      let g = y.length > 0 ? await l({
        cacheName: e,
        matchOptions: f,
        request: w
      }) : null;
      ...
      for (let t of y) await t.cacheDidUpdate.call(t, {
        cacheName: e,
        event: s,
        oldResponse: g,
        newResponse: d,
  ...
  function y(e) {
    if (!e) throw new r("add-to-cache-list-unexpected-type", {
      entry: e
    });
    if ("string" == typeof e) {
    ...
    if (!n) throw new r("add-to-cache-list-unexpected-type", {
      entry: e
    });
    if (!t) {
  ...
  class g {
    ...
    addToCacheList(e) {
      ...
      for (const n of e) {
        ...
        const {
          cacheKey: e,
          url: s
        } = y(n), i = "string" != typeof n && n.revision ? "reload" : "default";
        if (this.s.has(s) && this.s.get(s) !== e) throw new r("add-to-cache-list-conflicting-entries", {
          firstEntry: this.s.get(s),
          secondEntry: e
        });
        if ("string" != typeof n && n.integrity) {
          if (this.o.has(e) && this.o.get(e) !== n.integrity) throw new r("add-to-cache-list-conflicting-integrities", {
            url: s
          });
    ...
    async install({
      ...
      for (const [e, t] of this.s) r.has(t) ? s.push(e) : n.push({
        cacheKey: t,
        url: e
      });
      const o = n.map(({
    ...
    async l({
      ...
      if (!(a ? await a.cacheWillUpdate({
          ...
          request: o,
          response: l
        }) : l.status < 400)) throw new r("bad-precaching-response", {
        url: t,
        status: l.status
      });
      l.redirected && (l = await p(l)), await f({
        event: s,
        plugins: i,
        response: l,
    ...
    createHandlerBoundToURL(e, t = !0) {
      if (!this.getCacheKeyForURL(e)) throw new r("non-precached-url", {
        url: e
      });
  ...
  function v(e) {
    m || ((({
      ...
      self.addEventListener("fetch", s => {
        ...
        if (!r) return;
        let o = self.caches.open(c).then(e => e.match(r)).then(e => e || fetch(r));
        s.respondWith(o)
      })
    })(e), m = !0)
  }
  ...
  e.precacheAndRoute = function (e, t) {
    ! function (e) {
      q().addToCacheList(e), e.length > 0 && (self.addEventListener("install", K), self.addEventListener("activate", M))
    }(e), v(t)
  }
}));
//# sourceMappingURL=workbox-c8067db1.js.map